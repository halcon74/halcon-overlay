...
# Based on an ebuild from lanodanOverlay [1]
# [1] - https://github.com/gentoo-mirror/lanodanOverlay/blob/master/app-text/evince/evince-3.34.2.ebuild
...
KEYWORDS="~alpha amd64 ~arm ~arm64 ~ia64 ~mips ~ppc ~ppc64 ~sparc x86 ~x86-linux ~x64-solaris"
