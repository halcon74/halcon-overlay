...
* sys-libs/klibc - A minimal libc subset for use with initramfs. Dependency for sys-apps/v86d. Identical to the standard ebuild in ::gentoo before last-riting in March 2021.
