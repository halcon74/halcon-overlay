...
* sys-power/pm-utils - Two new versions, from my fork: 1.4.2 and 1.4.3. Re-made ebuilds. **Included all the patches present in ::gentoo before last-riting in January 2021 (1.4.2), non-specific Debian patches and a patch from c2p-overlay (1.4.3); fixed Gentoo bugs 666380, 579912, 549848 (1.4.2), 489650, 443530, 703026 and Debian bugs 485443, 659260 (1.4.3)**.
