...
* sys-power/pm-utils - Two new versions, from my fork: 1.4.2 and 1.4.3. Re-made ebuilds. Included all the patches present in ::gentoo before last-riting (January 2021), non-specific Debian patches and a patch from c2p-overlay; closed Gentoo bugs 666380, 579912, 549848, 489650, 443530, 703026 and Debian bugs 485443, 659260.
